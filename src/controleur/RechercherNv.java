...
public class RechercherNv extends JFrame {
    ...
    public ArrayList<User> ListUsers(String ValToSearch) {
        ...
        try {
            ...
            String searchQuery = "SELECT * FROM `reserverd` WHERE CONCAT(`id`, `destination`, `type`, `nbch`, `reduction`) LIKE '%" + ValToSearch + "%'";
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(RechercherNv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RechercherNv().setVisible(true);
            }
        });
    }
